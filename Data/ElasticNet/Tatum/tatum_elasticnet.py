...
def fetch_gamelog(player_id: int, season: str) -> pd.DataFrame:
    """Fetch one season of regular-season logs; uppercase columns; keep stable subset."""
    df = PlayerGameLog(player_id=player_id, season=season, season_type_all_star="Regular Season").get_data_frames()[0]
...
if __name__ == "__main__":
    ...
    out.to_csv("tatum_elasticnet_2024_25_predictions.csv", index=False)
    print("Saved CSV: tatum_elasticnet_2024_25_predictions.csv")
