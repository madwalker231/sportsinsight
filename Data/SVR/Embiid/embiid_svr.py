...
def save_plots(pred_df: pd.DataFrame):
    ...
    plt.title("Joel Embiid – Predicted vs Actual (2024–25)")
    plt.ylabel("Points")
    plt.tight_layout()
    plt.legend()
    plt.savefig("embiid_pred_vs_actual_2024_25.png", dpi=140)
    ...
    plt.xlabel("Points")
    plt.tight_layout()
    plt.savefig("embiid_residuals_hist_2024_25.png", dpi=140)
