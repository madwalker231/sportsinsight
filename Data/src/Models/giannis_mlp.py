...
if __name__ == "__main__":
    ...
    csv_path = "giannis_mlp_2024_25_predictions.csv"
    ...
    export_static_for_pages(
        ...
        plot_pred_path="giannis_pred_vs_actual_2024_25.png",
        plot_resid_path="giannis_residuals_hist_2024_25.png",
    )
    ...
    calib_info = {"a": 0.0, "b": 1.0, "corr": (None if not np.isfinite(corr_val) else corr_val), "desc": "identity (no calibration)"}
